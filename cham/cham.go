// Package cham grades an answer against something that can be checked.
//
	...
	return []Specialist{
		{
			...
			Source:  "any page of the corpus, since phoi.Bare turns it into a question whose answer sits beside it",
			Written: true,
		},
		{
			Name:    "trich",
...
// one by looking at it. [Dau] can, since a cut off restoration is a prefix of
