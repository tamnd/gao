...
// A Trich verifies that an answer rests on the instruments it should, and on
// nothing it made up.
//
...
// NewTrich returns a verifier over a register.
func NewTrich(r *Register) *Trich {
	return &Trich{register: r, want: map[string][]Citation{}}
}
...
func (t *Trich) Ask(prompt string, must ...string) bool {
...
func (t *Trich) Items() int { return len(t.want) }

// Specialist is the arm this verifies.
func (t *Trich) Specialist() string { return "trich" }

// Verify grades one answer.
func (t *Trich) Verify(prompt, answer string) Verdict {
