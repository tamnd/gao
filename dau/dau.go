// Package dau builds the diacritic restoration task set out of the corpus.
//
...
// and hands both to [soi.Measure], because a restoration is a reading of a page
