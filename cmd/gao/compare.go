...
`)
	...
	pairs, err := compare.ReadPairs(fs.Arg(0))
	if err != nil {
	...
	report := compareReport{Reading: r, Faults: r.Faults(), Blocking: r.Blocking(), Separates: r.Separates(), Holds: r.Holds(), Verdict: r.Verdict()}
