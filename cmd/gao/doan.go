...
`)
	...
	report := doanReport{
		...
		Rate:         r.Rate(),
		Quorum:       doan.Quorum,
		MinRate:      doan.MinRate,
		MaxRate:      doan.MaxRate,
		MaxWithdrawn: doan.MaxWithdrawn,
		Settled:      r.Settled(),
		Slices:       r.Slices(),
		Refused:      refused,
		Holds:        r.Holds(),
...
type doanReport struct {
	...
	Slices   []doan.Row        `json:"slices"`
	Register []doan.Prediction `json:"register,omitempty"`
...
func printDoan(w io.Writer, r doanReport, reg doan.Register) {
