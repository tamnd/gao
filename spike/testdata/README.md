...
this repository, which is the eight documents in `sift/testdata/langid/vietnamese`
and the six normalized documents in `normalize/testdata`, about seven and a half
